## created by version 2.0 write_timing_context -format icc2 -output ../output/RISC_V_macro_no_clk_alu/msrv32_alu.MCMM 
puts "Information: sourcing [info script]";
remove_modes -all;remove_corners -all;remove_scenarios -all;
namespace eval 6809145A {
