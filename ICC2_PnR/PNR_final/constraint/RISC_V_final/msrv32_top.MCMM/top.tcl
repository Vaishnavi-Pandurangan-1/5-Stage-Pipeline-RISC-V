## created by version 2.0 write_timing_context -format icc2 -output /home1/PD08/Vaishnavii/VLSI_PD/Main_Project_RISC_V/DC_Synthesis/synthesis_final/output/RISC_V_final/msrv32_top.MCMM 
puts "Information: sourcing [info script]";
remove_modes -all;remove_corners -all;remove_scenarios -all;
namespace eval 6809D2D2 {
