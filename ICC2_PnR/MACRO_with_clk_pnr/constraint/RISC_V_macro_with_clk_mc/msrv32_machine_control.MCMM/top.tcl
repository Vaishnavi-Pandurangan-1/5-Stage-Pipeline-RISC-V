## created by version 2.0 write_timing_context -format icc2 -output /home1/PD08/Vaishnavii/VLSI_PD/Main_Project_RISC_V/DC_Synthesis/MACRO_with_clk/output/RISC_V_macro_with_clk_mc/msrv32_machine_control.MCMM 
puts "Information: sourcing [info script]";
remove_modes -all;remove_corners -all;remove_scenarios -all;
namespace eval 68091A22 {
